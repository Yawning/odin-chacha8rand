...
chacha8rand_refill_simd128 :: proc(r: ^Chacha8Rand_State) {
	...
	when  ODIN_ARCH == .arm64 || ODIN_ARCH == .riscv64 {
		for _ in 0..<2 {
			...
			when ODIN_ENDIAN == .Little {
				intrinsics.unaligned_store(&dst[0], x0_0)
				intrinsics.unaligned_store(&dst[1], x1_0)
				intrinsics.unaligned_store(&dst[2], x2_0)
				intrinsics.unaligned_store(&dst[3], x3_0)
				intrinsics.unaligned_store(&dst[4], intrinsics.simd_add(x4_0, s4))
				intrinsics.unaligned_store(&dst[5], intrinsics.simd_add(x5_0, s5))
				intrinsics.unaligned_store(&dst[6], intrinsics.simd_add(x6_0, s6))
				intrinsics.unaligned_store(&dst[7], intrinsics.simd_add(x7_0, s7))
				intrinsics.unaligned_store(&dst[8], intrinsics.simd_add(x8_0, s8))
				intrinsics.unaligned_store(&dst[9], intrinsics.simd_add(x9_0, s9))
				intrinsics.unaligned_store(&dst[10], intrinsics.simd_add(x10_0, s10))
				intrinsics.unaligned_store(&dst[11], intrinsics.simd_add(x11_0, s11))
				intrinsics.unaligned_store(&dst[12], x12_0)
				intrinsics.unaligned_store(&dst[13], intrinsics.simd_add(x13_0, s13))
				intrinsics.unaligned_store(&dst[14], intrinsics.simd_add(x14_0, s14))
				intrinsics.unaligned_store(&dst[15], intrinsics.simd_add(x15_0, s15))

				intrinsics.unaligned_store(&dst[16], x0_1)
				intrinsics.unaligned_store(&dst[17], x1_1)
				intrinsics.unaligned_store(&dst[18], x2_1)
				intrinsics.unaligned_store(&dst[19], x3_1)
				intrinsics.unaligned_store(&dst[20], intrinsics.simd_add(x4_1, s4))
				intrinsics.unaligned_store(&dst[21], intrinsics.simd_add(x5_1, s5))
				intrinsics.unaligned_store(&dst[22], intrinsics.simd_add(x6_1, s6))
				intrinsics.unaligned_store(&dst[23], intrinsics.simd_add(x7_1, s7))
				intrinsics.unaligned_store(&dst[24], intrinsics.simd_add(x8_1, s8))
				intrinsics.unaligned_store(&dst[25], intrinsics.simd_add(x9_1, s9))
				intrinsics.unaligned_store(&dst[26], intrinsics.simd_add(x10_1, s10))
				intrinsics.unaligned_store(&dst[27], intrinsics.simd_add(x11_1, s11))
				intrinsics.unaligned_store(&dst[28], x12_1)
				intrinsics.unaligned_store(&dst[29], intrinsics.simd_add(x13_1, s13))
				intrinsics.unaligned_store(&dst[30], intrinsics.simd_add(x14_1, s14))
				intrinsics.unaligned_store(&dst[31], intrinsics.simd_add(x15_1, s15))
			} else {
				intrinsics.unaligned_store(&dst[0], _byteswap_u32x4(x0_0))
				intrinsics.unaligned_store(&dst[1], _byteswap_u32x4(x1_0))
				intrinsics.unaligned_store(&dst[2], _byteswap_u32x4(x2_0))
				intrinsics.unaligned_store(&dst[3], _byteswap_u32x4(x3_0))
				intrinsics.unaligned_store(&dst[4], _byteswap_u32x4(intrinsics.simd_add(x4_0, s4)))
				intrinsics.unaligned_store(&dst[5], _byteswap_u32x4(intrinsics.simd_add(x5_0, s5)))
				intrinsics.unaligned_store(&dst[6], _byteswap_u32x4(intrinsics.simd_add(x6_0, s6)))
				intrinsics.unaligned_store(&dst[7], _byteswap_u32x4(intrinsics.simd_add(x7_0, s7)))
				intrinsics.unaligned_store(&dst[8], _byteswap_u32x4(intrinsics.simd_add(x8_0, s8)))
				intrinsics.unaligned_store(&dst[9], _byteswap_u32x4(intrinsics.simd_add(x9_0, s9)))
				intrinsics.unaligned_store(&dst[10], _byteswap_u32x4(intrinsics.simd_add(x10_0, s10)))
				intrinsics.unaligned_store(&dst[11], _byteswap_u32x4(intrinsics.simd_add(x11_0, s11)))
				intrinsics.unaligned_store(&dst[12], _byteswap_u32x4(x12_0))
				intrinsics.unaligned_store(&dst[13], _byteswap_u32x4(intrinsics.simd_add(x13_0, s13)))
				intrinsics.unaligned_store(&dst[14], _byteswap_u32x4(intrinsics.simd_add(x14_0, s14)))
				intrinsics.unaligned_store(&dst[15], _byteswap_u32x4(intrinsics.simd_add(x15_0, s15)))
